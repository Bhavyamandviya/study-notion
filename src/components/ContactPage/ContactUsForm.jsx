        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row gap-1">
            ...
            <select
              name="dropdown"
              id="dropdown"
              className="bg-richblack-800 w-[100px] text-richblack-300 font-bold"
              {...register("countrycode", { required: true })}
            >
              {CountryCode.map((element, index) => {
                return (
                  <option key={index} value={element.code} className="p-2">
            ...
            <input
              ...
              className="text-black  w-[calc(100%-90px)] p-2"
              {...register("phoneNo", {
